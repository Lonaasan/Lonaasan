  ...
  <tr>
    ...
    <td valign="top">
      ...
      <p style="color: #ffffff; margin: 5px 0;">
        ...
        <a href="https://lona.moe/" style="color: #ffffff; text-decoration: none;">
          <img src="https://shadowlona.dev/assets/smol/link-solid-smol.png" alt="Link Icon" style="width: 13px; height: 10px;"> lona.moe
        </a><br>
